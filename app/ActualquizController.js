...
ngQuizApp.controller("ngQuizController", function ($scope, $http, $sce) {
   ...
   // var EOLRootPath = "http://localhost:55257/";
    ...
    $scope.ifQuiz = false;
    var unAnsweredQuestions = "", assessment_id, CDP_Item_ID, user_id, student_id, userRole, ifInfinteAttempts, skipAuthentication, skipAttemptScreen, pathInitialGet;
    ...
    $scope.nextPage = function nextPage() {
        ...
        if (enableNext == true) {
            if ($scope.isStudent) {//later on this condition should also include $scope.isInstructor - so data will be posted only for student and instructor
